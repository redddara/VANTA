...
const ACTIONS: Record<string, AuditMeta> = {
  ...
  "member.rename": { label: "Member renamed", tone: "warning" },
  "hacking.grant": { label: "Hacking practice granted", tone: "warning" },
  "hacking.revoke": { label: "Hacking practice revoked", tone: "negative" },
